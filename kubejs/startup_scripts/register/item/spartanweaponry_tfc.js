StartupEvents.registry("item", e => {
    ...
    // 19. （长+）长矛pike
    e.create("copper_pike", "spartanweaponry:pike").material(copper).setAttackDamage(3.7 - 1).setAttackSpeed(1.4).setDuration(300).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    // 19. （长+）长矛pike
    e.create("bronze_pike", "spartanweaponry:pike").material(bronze).setAttackDamage(4.45 - 1).setAttackSpeed(1.4).setDuration(600).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    // 19. （长+）长矛pike
    e.create("bismuth_bronze_pike", "spartanweaponry:pike").material(bismuth_bronze).setAttackDamage(4.45 - 1).setAttackSpeed(1.4).setDuration(400).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    // 19. （长+）长矛pike
    e.create("black_bronze_pike", "spartanweaponry:pike").material(black_bronze).setAttackDamage(4.6 - 1).setAttackSpeed(1.4).setDuration(400).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    // 19. （长+）长矛pike
    e.create("wrought_iron_pike", "spartanweaponry:pike").material(wrought_iron).setAttackDamage(5.05 - 1).setAttackSpeed(1.4).setDuration(1000).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    // 19. （长+）长矛pike
    e.create("steel_pike", "spartanweaponry:pike").material(steel).setAttackDamage(5.95 - 1).setAttackSpeed(1.4).setDuration(1500).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    // 19. （长+）长矛pike
    e.create("black_steel_pike", "spartanweaponry:pike").material(black_steel).setAttackDamage(7 - 1).setAttackSpeed(1.4).setDuration(4000).tag('tfc:usable_on_tool_rack');
    // 20. 投斧tomahawk
    ...
    e.create("red_steel_pike", "spartanweaponry:pike").material(red_steel).setAttackDamage(11.75 - 1).setAttackSpeed(1.1).setDuration(2100).tag('tfc:usable_on_tool_rack');
    ...
    e.create("blue_steel_pike", "spartanweaponry:pike").material(blue_steel).setAttackDamage(8.15 - 1).setAttackSpeed(1.9).setDuration(2100).tag('tfc:usable_on_tool_rack');
