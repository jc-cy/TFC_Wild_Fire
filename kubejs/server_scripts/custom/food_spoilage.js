...
const rotten_meat = [
    ...
    'butcher:rawfoxmeat', 'butcher:villager_meat', 'butcher:cooked_villager_meat',
    'butcher:hoglinmeat', 'butcher:cookedhoglinmeat', 'butcher:turtle_meat',
    'butcher:cookedturtlemeat', 'butcher:batmeat', 'butcher:cookedbatmeat',
    ...
    'tfc:food/cooked_gran_feline', 'brewery:fried_chicken', 'butcher:raw_pork_belly',
    'butcher:pork_belly', 'butcher:raw_pork_shoulder', 'butcher:pork_shoulder',
    'butcher:raw_pork_ham', 'butcher:raw_chuck_steak', 'butcher:chuck_steak',
    'butcher:raw_rump_steak', 'butcher:rump_steak', 'butcher:raw_lamb_shoulder',
    ...
    'naturalist:venison', 'naturalist:cooked_duck', 'butcher:foxmeat', 'butcher:rawllamameat',
    'butcher:rawpandameat', 'butcher:pandameat', 'butcher:rawbearmeat', 'butcher:bearmeat',
    'butcher:rawdolphinmeat', 'butcher:dolphinmeat', 'butcher:mincedbeef', 'butcher:camelmeat',
    'butcher:rawcamelmeat', 'butcher:elder_meat', 'butcher:raweldermeat',
    'butcher:cooked_dragon_meat', 'butcher:rawdragonmeat', 'butcher:cookedmincedlamb',
    'butcher:mincedlamb', 'butcher:cookedmincebeef', 'butcher:rawcreepermeat',
    'butcher:creepermeat', 'butcher:pillagermeat', 'butcher:cookedpillagermeat',
    'butcher:humanflesh', 'butcher:humanmeat', 'butcher:cookedhumanmeat',
